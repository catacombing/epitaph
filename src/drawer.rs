...
impl<'a> DrawerRun<'a> {
    ...
    fn batch_slider(&mut self, slider: &dyn Slider) -> Result<()> {
        ...
        let width = self.positioner.slider_size.width / self.positioner.scale_factor;
        let height = self.positioner.slider_size.height / self.positioner.scale_factor;
    ...
    fn batch_toggle(&mut self, toggle: &dyn Toggle) -> Result<()> {
        ...
        let size = self.positioner.module_size / self.positioner.scale_factor;
